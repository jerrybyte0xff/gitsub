...
/*******************************************************************************
* Function Name  : Lcd_Fill_Disp
* Description    : Fill The Lcd  A Single Color .
* Input          : The Color
* Output         : None
* Return         : None
* author         : jerry 
*******************************************************************************/
void Lcd_Fill_Disp(u16 Color)
{          
    u16 i,j;
    LCD_SETVSYNC
	LCD_SETHSYNC
...
void Lcd_ColorSet(u16 Color)
{
	...
	R = (Color & RGB565_MASK_RED) >> 11;  
	G = (Color & RGB565_MASK_GREEN) >> 5;  
	B = Color & RGB565_MASK_BLUE;  
