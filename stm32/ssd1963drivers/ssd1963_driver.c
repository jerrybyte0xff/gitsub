...
void LCD_SSD1963_init(void)
{
	...
	/* Set PLL MN */
		LCD_SSD1963_write_command(0x00E2);		
		LCD_SSD1963_write_parameter(0x0023);  
  ...
  /* Set LSHIFT Frequency */
		...
		LCD_SSD1963_write_parameter(0x0004);
		LCD_SSD1963_write_parameter(0x0093);
		LCD_SSD1963_write_parameter(0x00e0);
  ...
  /* Set GPIO Value */
	...
	/* Set PWM Configuration */
		...
		LCD_SSD1963_write_parameter(0x0006);
